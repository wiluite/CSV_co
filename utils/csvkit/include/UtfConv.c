...
{
	size_t ztUtf32 = 0;
	Utf16Char* pUtf16 = static_cast<Utf16Char*>(calloc(StrLenUtf32AsUtf16(pUtf32) + 1, sizeof(Utf16Char)));
	if (pUtf16) {
...
Utf32Char* Utf16ToUtf32(const Utf16Char* pUtf16) 
{
	size_t ztUtf16 = 0;
	size_t ztUtf32 = 0;
	Utf32Char* pUtf32 = static_cast<Utf32Char*>(calloc(CharLenUtf16(pUtf16) + 1, sizeof(Utf32Char)));
	if (pUtf32) {
		// https://datatracker.ietf.org/doc/html/rfc3629#page-4
		// This function skips data when UTF bytes are out of bounds
...
{
	size_t ztUtf32 = 0;
	Utf8Char* pUtf8 = static_cast<Utf8Char*>(calloc(StrLenUtf32AsUtf8(pUtf32) + 1, sizeof(Utf8Char)));
	if (pUtf8) {
		// https://datatracker.ietf.org/doc/html/rfc3629#page-4
		// This function skips data when UTF bytes are out of bounds
		while (pUtf32[ztUtf32] != 0) {
...
Utf32Char* Utf8ToUtf32(const Utf8Char* pUtf8) 
{
	size_t ztUtf8 = 0;
	size_t ztUtf32 = 0;
	Utf32Char* pUtf32 = static_cast<Utf32Char*>(calloc(CharLenUtf8(pUtf8) + 1, sizeof(Utf32Char)));
	if (pUtf32) {
		// https://datatracker.ietf.org/doc/html/rfc3629#page-4
		// This function skips data when UTF bytes are out of bounds
		while (pUtf8[ztUtf8] != 0) {
